    ...
    return (
        <Box>
            ...
            <Flex w='100%' mt='6' maxWidth={1480} mx='auto' px='6'>
                <SideBar />
                <Box flex='1' as='form' borderRadius={8} bg='gray.800' p={['6', '8']} onSubmit={handleSubmit(handleCreateUser)}>
                    ...
                    <VStack spacing='8'>
                        ...
                        <SimpleGrid minChildWidth='240px' spacing={['6', '8']} w='100%'>
                            ...
                            <Input name='password_confimation' type='password' label='Confirmação de Senha' {...register('password_confirmation')} error={errors.password_confirmation} />
                        </SimpleGrid>
                    </VStack>
